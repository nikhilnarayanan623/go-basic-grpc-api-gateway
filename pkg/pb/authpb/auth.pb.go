...
func (x *SignupRsponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignupRsponse) ProtoMessage() {}

func (x *SignupRsponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_pb_auth_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignupRsponse.ProtoReflect.Descriptor instead.
func (*SignupRsponse) Descriptor() ([]byte, []int) {
	return file_pkg_pb_auth_proto_rawDescGZIP(), []int{2}
}

func (x *SignupRsponse) GetStatus() *Response {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *LoginResponse) GetStatus() *Response {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *ValidateResponse) GetStatus() *Response {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_pkg_pb_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0x35, 0x0a, 0x0d, 0x53, 0x69, 0x67, 0x6e, 0x75, 0x70, 0x52, 0x73, 0x70,
	...
	0x73, 0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x40, 0x0a, 0x0c, 0x4c, 0x6f,
	...
	0x70, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06, 0x73, 0x74, 0x61,
	...
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x34, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x51, 0x0a, 0x10,
	...
	0x32, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06,
	...
	0x34, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x75, 0x70, 0x12, 0x11, 0x2e,
	0x70, 0x62, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x75, 0x70, 0x52, 0x73, 0x70, 0x6f,
	...
	0x0f, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x70, 0x62,
...
var file_pkg_pb_auth_proto_goTypes = []interface{}{
	...
	(*SignupRsponse)(nil),    // 2: pb.SignupRsponse
...
var file_pkg_pb_auth_proto_depIdxs = []int32{
	0, // 0: pb.SignupRsponse.status:type_name -> pb.Response
	0, // 1: pb.LoginResponse.status:type_name -> pb.Response
	0, // 2: pb.ValidateResponse.status:type_name -> pb.Response
	...
	2, // 6: pb.AuthService.UserSignup:output_type -> pb.SignupRsponse
